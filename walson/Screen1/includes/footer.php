...
<footer id="myFooter" class="mt-5">
        <div class="container">
            <div class="row">
                <div class="col-sm-3">
                    <h2 class="logo"><a href="index.php"><img src=''></a></h2>
                </div>
                <div class="col-sm-2">
                    <h5>Get started</h5>
                    <ul>
                        ...
                        <li><a href="forum.php">The Forum</a></li>
                        <li><a href="hub.php">The Hub</a></li>
                    </ul>
                </div>
                <div class="col-sm-2">
                    <h5>About us</h5>
                    <ul>
                        <li><a href="_klik creators/klik_saad.php">Ecera System</a></li>
